...
[ ] `soc` tab. `make -B -f ULX4M_LD_85F.mk`

[ ] ULX4M in bootloader mode.

[ ] `syth` tab. `./openFPGALoader.exe --dfu --vid 0x1d50 --pid 0x614b --altsetting 0 fpga_ulx4m_ld.bit`
[ ] Power cycle, ULX4M *NOT* in bootloader mode.

[ ] `fw` tab.  Build Doom: `HAZARD3_SYS_CLK_HZ=25000000 ./build.sh`
...
[ ] `WAD` tab. Load Doom `py .\doom\upload-doom-image.py  .\doom\build-doom-image\hazard3-doom.h3d  --port COM10`
[ ]  putty: connect to COM10 and test.
