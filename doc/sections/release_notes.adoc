...
* `eco_version` allows part of the processor's reported version number to be driven externally (see <<reg-h3.misa>>)

New features:

* Implement the Zilsd and Zclsd extensions (load/store pair and compressed load/store pair)
* Implement the Zbkx extension (crossbar permutation)
