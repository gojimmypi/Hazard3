...
This document describes Hazard3 version https://github.com/Wren6991/Hazard3/releases/tag/v1.1[v1.1]. See <<section-release-notes>> for changes introduced in this and earlier versions.
