...
This document describes Hazard3 version 1.1-rc1. See <<section-release-notes>> for changes introduced in this and earlier versions.
...
image::diagrams/hazard3_interfaces_both.drawio.png[pdfwidth=60%, align="center"]
...
image::diagrams/hazard3_pipeline.drawio.png[pdfwidth=100%]
